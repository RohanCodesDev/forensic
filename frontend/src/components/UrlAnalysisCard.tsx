  ...
  return (
    <div className="bg-black border border-gray-800 p-4 md:p-6 rounded-lg">
      <h3 className="text-gray-400 text-xs uppercase font-semibold tracking-wider mb-4 flex items-center gap-2 font-mono">
        ...
        <InfoTooltip
          title="Embedded Link & URL Analysis"
          explanation="Extracts and evaluates every web link found in the email. Detects URL shorteners used to hide destinations, deceptive text (where text says paypal.com but links elsewhere), and direct IP addresses."
        />
      </h3>
