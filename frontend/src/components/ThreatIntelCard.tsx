    ...
    <div className="bg-[#050505] border border-gray-800 p-4 md:p-6 rounded-lg space-y-4">
      <div className="border-b border-gray-800 pb-3 mb-4">
        <h3 className="text-white font-semibold flex items-center gap-2 font-mono">
          ...
          <InfoTooltip
            title="Global Threat Intelligence (CTI)"
            explanation="Cross-references the sender IP address, domains, and links against international cybersecurity blacklists (AbuseIPDB, URLhaus, VirusTotal) to verify if they have been previously reported in cyberattacks or botnets."
          />
        </h3>
