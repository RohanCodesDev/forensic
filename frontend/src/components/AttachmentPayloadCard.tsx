    ...
    <div className="bg-[#050505] border border-gray-800 rounded-xl p-4 md:p-6 space-y-4" id="section-attachments">
      ...
      <div className="flex items-center justify-between border-b border-gray-800 pb-3">
        <h3 className="text-sm font-mono font-bold uppercase tracking-wider text-white flex items-center gap-2">
          ...
          <InfoTooltip
            title="Attachment Malware Sandbox"
            explanation="Inspects email attachments for hidden viruses, dangerous file formats (.exe, .scr), malicious Office macros, file type spoofing, and checks hashes against VirusTotal malware signatures."
          />
        </h3>
